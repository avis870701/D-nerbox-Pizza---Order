...
UPDATE Product SET ProductImg_url = '\images\向日葵1.jpg' WHERE ProductId = ３３;
SELECT * FROM Product;
...
--產品表鍵入值
INSERT INTO Product (CategoryId,ProductName,ProductDesc,ProductImg_url,ProductPrice)
VALUES 
(1,'夏威夷德國披薩','火腿鳳梨披薩。白醬，薄餅皮。','\product\images\夏威夷德國比薩.jpg',279),
(1,'海鮮德國披薩','蝦仁、魚、蟹味腿。白醬，薄餅皮。','\product\images\海鮮德國比薩.jpg',289),
(1,'牛肉K吧德國披薩','旋轉烤牛肉。白醬，薄餅皮。','\product\images\牛肉K吧德國比薩.jpg',259),
(1,'臘腸義大利披薩','臘腸。紅醬，薄餅皮。','\product\images\臘腸意大利比薩.jpg',269),
(1,'瑪格麗塔披薩','莫札瑞拉起司。羅勒，番茄，紅醬，薄餅皮。','\product\images\瑪格麗塔披薩.jpg',240),
(2,'義大利牛肉K吧焗烤麵','旋轉烤牛肉。焗烤，白醬，義大利麵。','\product\images\牛肉K吧焗烤麵.jpg',170),
(2,'義大利雞肉焗烤麵','雞肉。焗烤，白醬，義大利麵。','\product\images\義大利雞肉焗烤麵.jpg',170),
(2,'鮪魚焗烤薯條','帕瑪森起司。焗烤，薯條。','\product\images\鮪魚焗烤薯條.jpg',150),
(2,'雞肉焗烤薯條','雞肉。焗烤，薯條。','\product\images\雞肉焗烤薯條.jpg',170),
(2,'牛肉K吧焗烤薯條','旋轉烤牛肉。焗烤，薯條。','\product\images\牛K吧焗烤薯條.jpg',170),
(3,'炸起司條(5)','酥炸起司條搭配番茄醬','\product\images\炸起司條(5條).jpg',89),
(3,'薯條','酥炸薯條佐番茄醬','\product\images\薯條.jpg',79),
(3,'雞塊(6)','酥酥脆脆的雞塊','\product\images\炸雞塊(6塊).jpg',89),
(4,'蘋果肉桂德國烤餅','新鮮蘋果、肉桂與酥脆薄餅的絕妙搭配','\product\images\蘋果肉桂德國烤餅.jpg',150),
(5,'可口可樂','冰涼爽口的可口可樂,主廚推薦','\product\images\可樂.jpg',39),
(5,'雪碧','冰涼爽口的雪碧','\product\images\雪碧.jpg',39),
(5,'蘋果汁','進口蘋果汁','\product\images\蘋果汁.jpg',49)
;
--
--產品附加項表設計
