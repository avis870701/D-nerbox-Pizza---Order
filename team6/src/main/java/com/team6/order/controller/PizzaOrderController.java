...
@SessionAttributes({"orderId","account", "oriAmount", "discount", "discountPrice", "paidAmount", "payment", "pickup", "orderStatus", "detailsIds", "productIds", "products", "unitPrices", "quantitys", "subtotals", "notes","member"})
public class PizzaOrderController {
	...
	public String PizzaOrderIndex(@SessionAttribute("member") String member) {
		if(member != null) {
	...
	public String DeliveryOrderIndex(@SessionAttribute("member") String member) {
		if(member != null) {
