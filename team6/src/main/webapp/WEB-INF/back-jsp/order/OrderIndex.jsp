							...
							<div class="row">
								...
								<div class="card-body p-4">
									<div class="row justify-content-end p-2">
										...
										<div class="text-center bg-white font-weight-bold text-primary col-12"
													...
													<div class="input-group">
														...
														<div class="input-group-append">
															<button id="goToPageBtn"
																class="btn btn-dark m-1">跳轉</button>
														</div>
													</div>
												</div>
											</div>
									...
									<!-- discount modal -->
									<div id="updateDiscountModal" class="modal" tabindex="-1" role="dialog">
									...
									<!-- cancelNote modal -->
									<div class="modal fade" id="cancelNoteModal" tabindex="-1" role="dialog"
										aria-labelledby="cancelNoteModalLabel" aria-hidden="true">
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												<div class="modal-header">
										...
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-body">
													...
													<br>
													<div class="form-group">
														<label for="orderProductSelect" class="p-1">選擇餐點：</label>
													...
													<br>
													<div>
														<label>醬料選擇：</label> <input type="radio" name="sauce" value="紅醬"
															disabled> 紅醬 <input type="radio" name="sauce" value="白醬"
															disabled> 白醬
													</div>
													<br>
													<div>
