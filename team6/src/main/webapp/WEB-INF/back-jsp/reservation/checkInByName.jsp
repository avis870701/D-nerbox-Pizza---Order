                    ...
                    <table>
                        <thead>
                            <tr>
                                ...
                                <th>人數</th>
                                <th>備註</th>
                                <th style="width:150px">報到完成</th>
                                <th style="width:150px">刪除</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <% List<Reserve> selectName = (ArrayList<Reserve>)
                                        request.getAttribute("selectName");
                                        ...
                                        <td style="width:min-content"><button type="button"
                                                onclick="checkInSuccess('<%= selectNames.getReservationId() %>')">報到完成</button>
                                        </td>
                                        <td style="width:min-content"><button type="button"
                                                onclick="deleteCheckIn('<%= selectNames.getReservationId() %>')">刪除</button>
                                        </td>
                            </tr>
                            <% } %>
                        </tbody>
