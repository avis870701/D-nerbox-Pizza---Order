										...
										<div class="table-responsive">
											<table class="table text-nowrap mb-0 align-middle">
												...
												<td><label for="mPhoto"><i class="fa fa-user"></i>
															會員頭貼</label></td>
													<td><img src="${member.detailBean.mPhoto}" alt=""
												...
												<tr>
													...
													<td><input class="form-control" type="text"
														...
														required value="${member.detailBean.mEmail}" readonly></td>
												</tr>
												<tr>
												...
												<tr>
													...
													<td><input class="form-control" type="date"
														...
														value="${member.detailBean.mbirthday}" readonly></td>
												</tr>
											</table>
											<br>
											<table class="table text-nowrap mb-0 align-middle">
												<tbody>
													<tr>
														<td class="border-bottom-0 text-center"><a href="MemberGoToUpdate"><button class="btn btn-danger">修改資料</button></a></td>
													</tr>
												</tbody>
											</table>
										</div>
