	...
	<body>
		...
		<div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
			<div class="container text-center py-5">
				<h1 class="display-2 text-dark mb-4 animated slideInDown">重置密碼</h1>
				<nav aria-label="breadcrumb animated slideInDown">
					<ol class="breadcrumb justify-content-center mb-0">
						<li class="breadcrumb-item"><a href="#">首頁</a></li>
						<li class="breadcrumb-item"><a href="#">會員</a></li>
						<li class="breadcrumb-item text-dark" aria-current="page">重置密碼</li>
					</ol>
				</nav>
			</div>
		</div>
					...
					<div class="col-md-8 col-lg-6">
						<div class="card mb-0">
							<div class="card-body">
								...
								<form method="POST" action="changePwdByToken">
									<div class="mb-6">
										<i class="fa fa-user icon"></i><label for="exampleInputtext1"
											class="form-label">新密碼</label>
										<input type="password" class="form-control" id="exampleInputtext1"
											aria-describedby="textHelp" name="pwd" required>
									</div>
									<br>
									<div class="mb-6">
										<i class="fa fa-key icon"></i><label for="exampleInputPassword1"
											class="form-label">再次輸入密碼</label>
									...
									<br>
									<button type="submit"
										class="btn btn-primary w-100 py-8 fs-4 mb-4 rounded-2">確認</button>
								</form>
							</div>
						</div>
					</div>
