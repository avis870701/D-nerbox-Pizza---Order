						...
						<nav id="navbar-example2" class="navbar navbar-light bg-light px-3 sticky-top ">
							<div class="d-flex flex-grow-1">
								<ul class="nav nav-pills flex-grow-1">
									...
									<li class="nav-item dropdown"><a class="nav-link dropdown-toggle fs-3"
											data-bs-toggle="dropdown" href="#" role="button"
											aria-expanded="false">焗烤類</a>
									...
									<li class="nav-item"><a class="nav-link fs-3" href="#deepFried">炸物</a></li>
									<li class="nav-item"><a class="nav-link fs-3" href="#dessert">甜點</a></li>
						...
						<div class="col-12 justify-content-center">
							...
							<div class="col-10 d-flex justify-content-center">
								<div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-offset="0"
									class="scrollspy-example row" tabindex="0">
									<h2 class="mb-3">Pizza</h2>

									<div class="col-lg-3 col-md-3 wow fadeInUp" data-wow-delay="0.1s" id="pizza">
									...
									<div class="col-lg-3 col-md-3 wow fadeInUp" data-wow-delay="0.1s">
										<div class="store-item position-relative text-center">
											<img class="img-fluid" src="\images\product\Shrimp_pineapple.png" alt=""
												style="width: 247px; height: 181px;">
											<div class="p-4">
												<h4 class="mb-3">鳳梨蝦仁披薩</h4>
												<p>Shrimp pineapple</p>
												<h4 class="text-primary">$279</h4>
												<input type="hidden" name="productId" value="3"> <input type="hidden"
													name="productId" value="3">
											</div>
											<div class="store-overlay">
												<button type="button" class="btn btn-dark rounded-pill py-2 px-4 m-2"
													onclick="showPizzaOrderModal(this)">
									...
									<div class="col-lg-3 col-md-3 wow fadeInUp" data-wow-delay="0.1s">
										<div class="store-item position-relative text-center">
											<img class="img-fluid" src="\images\product\牛肉K吧德國比薩.jpg" alt="">
											<div class="p-4">
									...
									<div class="col-lg-3 col-md-3 wow fadeInUp" data-wow-delay="0.1s">
										<div class="store-item position-relative text-center">
											<img class="img-fluid" src="\images\product\Chicken_Bacon.jpg" alt=""
												style="width: 247px; height: 181px;">
											<div class="p-4">
									...
									<div class="col-lg-3 col-md-3 wow fadeInUp" data-wow-delay="0.1s" id="bakedNoodles">
										<div class="store-item position-relative text-center">
											<img class="img-fluid" src="\images\product\Baked_cheese_fries.jpg" alt="">
											<div class="p-4">
												<h4 class="mb-3">
													起司焗烤麵
												</h4>
									...
									<div class="col-lg-3 col-md-3 wow fadeInUp" data-wow-delay="0.1s">
										<div class="store-item position-relative text-center">
											<img class="img-fluid" src="\images\product\義大利雞肉焗烤麵.jpg" alt=""
									...
									<div class="col-lg-3 col-md-3 wow fadeInUp" data-wow-delay="0.1s">
										<div class="store-item position-relative text-center">
											<img class="img-fluid" src="\images\product\Seafood_noodels.jpg" alt=""
												style="width: 247px; height: 185px;">
											<div class="p-4">
									...
									<div class="col-lg-3 col-md-3 wow fadeInUp" data-wow-delay="0.1s" id="bakedFries">
										<div class="store-item position-relative text-center">
									...
									<div class="col-lg-3 col-md-3 wow fadeInUp" data-wow-delay="0.1s" id="deepFried">
										<div class="store-item position-relative text-center">
									...
									<div class="col-lg-3 col-md-3 wow fadeInUp" data-wow-delay="0.1s">
										<div class="store-item position-relative text-center">
											<img class="img-fluid" src="\images\product\炸起司條(5條).jpg" alt="">
											<div class="p-4">
												<h4 class="mb-3">
													炸起司條(5)
												</h4>
									...
									<div class="col-lg-3 col-md-3 wow fadeInUp" data-wow-delay="0.1s" id="dessert">
										<div class="store-item position-relative text-center">
											<img class="img-fluid" src="\images\product\蘋果肉桂德國烤餅.jpg" alt="">
											<div class="p-4">
									...
									<div class="col-lg-3 col-md-3 wow fadeInUp" data-wow-delay="0.1s">
										<div class="store-item position-relative text-center">
											<img class="img-fluid" src="\images\product\Apple pudding flammkuchen.jpg"
												alt="" style="width: 200px; height: 170px;">
											<div class="p-4">
									...
									<div class="col-lg-3 col-md-3 wow fadeInUp" data-wow-delay="0.1s" id="drink">
										<div class="store-item position-relative text-center">
												...
												<div class="modal-body">
													...
													<div class="form-check">
														...
														<input class="form-check-input" type="radio" name="sauce"
															id="whiteSauce" value="白醬"> <label class="form-check-label"
															for="whiteSauce">白醬</label>
													</div>
													<div class="form-check">
														<input class="form-check-input" type="radio" name="sauce"
															id="redSauce" value="紅醬"> <label class="form-check-label"
															for="redSauce">紅醬</label>
													</div>
													<br> 配料加選
													<div class="form-check">
													...
													<div class="form-check">
														<input class="form-check-input" type="checkbox" id="mushroom"
															value="加洋菇"> <label class="form-check-label"
															for="mushroom">加洋菇 +30</label>
													</div>
													<div class="mb-3">
												...
												<div class="modal-body">
													...
													<div class="form-check">
														<input class="form-check-input" type="radio" name="sauce"
															...
															for="whiteSauceBakedNoodles">白醬</label>
													</div>
													<div class="form-check">
														<input class="form-check-input" type="radio" name="sauce"
															id="redSauceBakedNoodles" value="紅醬"> <label
															class="form-check-label"
															for="redSauceBakedNoodles">紅醬</label>
													</div>
													<br> 配料加選
													<div class="form-check">
											...
											<div class="modal-content">
												...
												<div class="modal-body">
													...
													<input type="hidden" name="account" id="account"
														value="memberAccount"> <input type="hidden" name="discountPrice"
														id="discountPrice" value=""> <input type="hidden" name="payment"
														id="payment" value="">
										...
										<table class="table table-responsive" id="cartTable">
											<thead>
												<tr>
													...
													<th scope="col" nowrap><i class="fa-regular fa-trash-can"></i></th>
												</tr>
											</thead>
