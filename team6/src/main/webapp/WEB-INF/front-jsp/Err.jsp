	...
	<body>
		...
		<div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
			<div class="container text-center py-5">
				<h1 class="display-2 text-dark mb-4 animated slideInDown">發生錯誤</h1>
				<nav aria-label="breadcrumb animated slideInDown">
					<ol class="breadcrumb justify-content-center mb-0">
						<li class="breadcrumb-item"><a href="#">系統</a></li>
						<li class="breadcrumb-item"><a href="#">首頁</a></li>
						<li class="breadcrumb-item text-dark" aria-current="page">發生錯誤</li>
					</ol>
				</nav>
			</div>
		</div>
					...
					<div class="col-md-8 col-lg-6">
						<div class="card mb-0">
							<div class="card-body">
								...
								<p class="text-center">發生錯誤</p>
								<br>
								<h2 class="text-center" style="color:red;">${err}</h2>
								<br>
							</div>
						</div>
					</div>
